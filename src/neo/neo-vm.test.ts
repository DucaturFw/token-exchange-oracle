...
test('parse mint contract call with reverse hex error', () =>
{
...
test('parse mint contract call without reverse hex error', () =>
{
	let txScript = '013003656f7308404b4c00000000001427c3d71a87b7cc901a5b1ac1611dfaf54cf749f154c10a6d696e74546f6b656e73678adc2546282d56f373b31533d4326fcd18484efe'
	let ec = parseMintCall(txScript)
	expect(ec).toBeDefined()
	if (!ec)
		return
